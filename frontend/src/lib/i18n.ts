...
const strings = {
  gu: {
    ...
    navMockTest: "મોક ટેસ્ટ",
    navRevision: "પુનરાવર્તન",
    navDoubts: "શંકા પૂછો",
    navDailyTarget: "આજનું લક્ષ્ય",
    ...
    notifMotivational: "પ્રેરણાદાયક સંદેશા",
  ...
  en: {
    ...
    navDoubts: "Ask a Doubt",
    navDailyTarget: "Daily Target",
    ...
    notifMotivational: "Motivational messages",
